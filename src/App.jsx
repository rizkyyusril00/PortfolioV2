...
function App() {
  ...
  const togleClick = () => {
    if (value % 2 === 1) {
      // Check if odd click (first click or every other odd click)
  ...
  return (
    <>
      <div className={value === 1 ? "bg-transparent" : "bg-bg"}>
        ...
        <Main
          value={value}
          togleClick={togleClick}
          blobShow={blobShow}
          navMenu={navMenu}
          handleMenuHome={handleMenuHome}
          handleMenuAbout={handleMenuAbout}
          handleMenuProject={handleMenuProject}
          handleMenuCertificate={handleMenuCertificate}
        />
      </div>
    </>
  );
