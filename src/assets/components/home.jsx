    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-6 py-4">
                            <div className="flex items-center gap-4">
                                <i className="bi bi-person-raised-hand text-[24px] text-primary"></i>
                                <h2 className="text-[24px] text-primary">Get in Touch</h2>
                            </div>
                            <h2 className="text-[24px] text-primary text-center">Send Me a Message</h2>
                            <form action="" className="">
                                <div className="flex flex-col gap-4">
                                    <div className="flex gap-4">
                                        {/* name */}
                                        <div className="form-group field">
                                            <input required="" placeholder="Name" className="form-field" type="input" />
                                            <label className="form-label" htmlFor="name">Name</label>
                                        </div>
                                        {/* email */}
                                        <div className="form-group field">
                                            <input required="" placeholder="Name" className="form-field" type="email" />
                                            <label className="form-label" htmlFor="name">Email</label>
                                        </div>
                                    </div>
                                    <label className="text-primary">Write Your Message</label>
                                    <textarea name="" id="" rows="5" className="text-primary rounded-md p-2 ml-[1px] resize-none transition-all ease-in-out duration-500"></textarea>
                                    {/* submit */}
                                    <button type="submit" className="btnSubmit w-[20%] h-10">Send
                                    </button>
                                </div>
                            </form>
            </div>
