    ...
    return(
        <>
            ...
            <div className="flex flex-col items-center gap-10 py-8 border-t border-dashed border-primary">
                {/* atas */}
                <AboutContent content="Bachelor of Computer Science, majoring in Information Systems, Nusa Putra University. I have found joy in my challenging academic journey. As an individual who enjoys learning new things, my confidence is tested through leadership roles in leading various projects and managing events."/>
                {/* bawah */}
