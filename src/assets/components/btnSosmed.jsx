...
export default function BtnSosmed (){
    ...
    return(
        <>
            {sosmeds.map((sosmed) => (
                <a href={sosmed.url} target="_blank" key={sosmed.id} className="w-8 h-8 md:w-6 md:h-6 slg:w-9 slg:h-9 lg:w-12 lg:h-12 bg-[#00010D] rounded-full flex items-center justify-center relative group">
